...
public class DoctorScheduleDAO {
    ...
    // Retrieve the doctor's full schedule regardless of status - used by the
    // doctor's own Schedule tab so booked slots don't disappear from view.
    // (getAvailableSchedules below stays AVAILABLE-only for patient-facing use.)
    public java.util.List<DoctorSchedule> getAllSchedulesByDoctor(int doctorId) {
