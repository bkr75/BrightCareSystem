...
// Shared look-and-feel for the Doctor module, matching the Receptionist and
// Patient portals so all four client modules present a consistent theme.
public final class DoctorTheme {
    ...
    public static void setStatus(JLabel statusLabel, Response response) {
